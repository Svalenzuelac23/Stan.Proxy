...
namespace Cross.Proxy
{
    public class Proxy : IProxy
    {
        ...
        public async Task<TModel> Get<TModel>(Uri uri) where TModel : class
        {
        ...
        public async Task<TModel> Get<TModel>(Uri uri,
            KeyValuePair<string, string> auth,
        ...
        public async Task<TModel> PostAsync<TModel>(Uri url, [NotNull] object body, string endPoint = null) where TModel : class
        {
        ...
        public async Task PostAsync(Uri url, [NotNull] object body, string endPoint = null)
        {
            var request = new HttpRequestMessage()
            {
                Method = HttpMethod.Post,
        ...
        public async Task<TModel> PutAsync<TModel>(Uri url, object body, string endPoint = null) where TModel : class
        {
            var request = new HttpRequestMessage()
            {
                Method = HttpMethod.Put,
